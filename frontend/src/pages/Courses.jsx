...
const Courses = () => {
  ...
  const loadCourses = () => {
    ...
    api.get('/courses', { params })
      ...
      .catch(() => { setCourses([]); setTotal(0); setError(true); })
        ...
        <div className="container-custom">
          ...
          {loading ? (
            ...
            <div className="text-center py-16">
              <p className="font-body text-text/60 text-lg mb-4">We couldn't load the courses right now. Please try again.</p>
              <button
                onClick={loadCourses}
                className="bg-accent text-white px-6 py-2.5 rounded-lg font-body font-medium hover:bg-accent/90 transition-colors"
              >
                Try Again
              </button>
            </div>
